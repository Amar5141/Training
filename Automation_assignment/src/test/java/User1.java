...
public class User1 extends LocatorsHandling {
	...
	WebDriver driver;
	 ...
	 @Test
	 (priority = 1)
	 public void a_login_test() throws FileNotFoundException, Exception {
		 
		 /* LOGIN */
		 LoginPage login = new LoginPage();
		 login.click_on_sign_in(driver);
		 super.fetch_credentials("user00");
	 ...
	 @Test 
	 public void b_home_page(WebDriver driver) throws FileNotFoundException, InterruptedException {
	 ...
	 public void c_search_result(WebDriver driver) throws FileNotFoundException {
	 ...
	 public void d_apply_filters(WebDriver driver) throws FileNotFoundException, InterruptedException {
